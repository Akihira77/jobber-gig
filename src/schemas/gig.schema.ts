...
export const gigCreateSchema: ObjectSchema = j.object().keys({
    ...
    tags: j.array().items(j.string()).required().min(1).messages({
    ...
    price: j.number().required().greater(4.99).messages({
    ...
    coverImage: j.string().required().messages({
    ...
    expectedDelivery: j.string().required().messages({
    ...
    basicTitle: j.string().required().messages({
    ...
    basicDescription: j.string().required().messages({
...
export const gigUpdateSchema: ObjectSchema = j.object().keys({
    title: j.string().required().messages({
        "string.base": "Please add a gig title",
        "string.empty": "Gig title is required",
        "any.required": "Gig title is required"
