...
export async function addGig(req: Request, res: Response): Promise<void> {
...
export async function removeGig(req: Request, res: Response): Promise<void> {
...
export async function getGigById(req: Request, res: Response): Promise<void> {
...
export async function getSellerActiveGigs(
    ...
    const gigs = await gigService.getSellerActiveGigs(req.params.sellerId);
...
export async function getSellerInactiveGigs(
    ...
    const gigs = await gigService.getSellerInactiveGigs(req.params.sellerId);
...
export async function getGigsMoreLikeThis(
    req: Request,
    res: Response
): Promise<void> {
    const resultHits: ISellerGig[] = [];
...
export async function getGigsQuerySearch(
    req: Request,
    res: Response
): Promise<void> {
    ...
    const gigs: ISearchResult = await gigService.gigsSearch(
        String(query),
        paginate,
...
export async function updateGig(req: Request, res: Response): Promise<void> {
    ...
    const updatedGig = await gigService.updateGig(req.params.gigId, gigData);
...
export async function updateActiveStatusGig(
    req: Request,
    res: Response
): Promise<void> {
    const updatedGig = await gigService.updateActiveGigProp(
        req.params.gigId,
        req.body.active
    );
...
export async function populateGigs(req: Request, res: Response): Promise<void> {
